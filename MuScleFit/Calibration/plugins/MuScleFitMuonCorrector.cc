...
//
// $Id: MuScleFitMuonCorrector.cc,v 1.9.2.2 2013/05/22 12:13:45 scasasso Exp $
//
...
/**
  ...
  \version  $Id: MuScleFitMuonCorrector.cc,v 1.9.2.2 2013/05/22 12:13:45 scasasso Exp $
*/
