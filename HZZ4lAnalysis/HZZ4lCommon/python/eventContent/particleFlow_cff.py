...
particleFlow4mu = cms.untracked.vstring(
    'keep *_cmgDiMuonDiMuon_*_*'
    )

particleFlow = particleFlowJets + particleFlowMuons + particleFlowElectrons + particleFlowPhotons + particleFlowHemispheres + particleFlowMisc + particleFlow4mu

#eventualy add particleFlowMET, particleFlowTaus, particleFlowW, particleFlowVBF
